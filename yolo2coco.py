...
parser.add_argument('--image_path', default='datasets/drone11/images', type=str, help="path of images")  # 图片路径改一下
parser.add_argument('--label_path', default='datasets/drone11/labels', type=str, help="path of labels.txt")  # 图片标签路径改一下
parser.add_argument('--save_path', type=str, default='datasets/drone.json',
